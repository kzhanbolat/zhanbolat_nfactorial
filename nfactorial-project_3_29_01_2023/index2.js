    ...
    (data.splice(0,5).forEach(item => {
        ...
        <div class = "content">
            ...
            <div class = "content_head">
                ...
                <h5>Author name: ${item.userId}</h5>

                <a href="article.html" class="button"><h4>Title: ${item.title}</h4></a>
            ...
            <div class = "content_bottom">
                ...
                <div class = "bottom_stracture">
                    ...
                    <div class = "bottom_text">
                        ...
                        <h6>Java Script 12 min read Selected for you</h6>
        ...
        <div class="img">
            ...
            <img src="./assets/${item.id}.png" alt="img">
